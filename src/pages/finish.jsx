...
const Finish = () => {
    ...
    return (
        <div>
            ...
            <h1 className='top-[80%] left-1/2 -translate-x-1/2 absolute text-2xl font-bold opacity-0 text-center' id="free">$20 Chipotle gift card <br></br> + <br></br> One time free pickup</h1>
