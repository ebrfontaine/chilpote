    ...
    return (
        <div>
            ...
            <div className='flex justify-center'>
                <div  className='top-[59%] -translate-y-1/2 absolute w-[312px] h-[194px] rounded-xl bg-[#e9eaea] animate-bounce'>
            ...
            <h1 className='top-[83%] left-1/2 -translate-x-1/2 absolute text-2xl font-bold opacity-0 text-center' id="free">$20 Chipotle gift card <br></br> + <br></br> One time free pickup</h1>
